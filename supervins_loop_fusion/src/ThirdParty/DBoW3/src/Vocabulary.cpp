...
namespace DBoW3
{
      ...
      const std::vector<std::vector<cv::Mat>> &training_features)
  {
    ...
    // create the words
    std::cout << "正在创建词袋5" << std::endl;
    createWords();

    std::cout << "正在创建词袋6" << std::endl;
